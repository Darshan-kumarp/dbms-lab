...
SALESMAN_ID INT(5) REFERENCES SALESMAN(SALESMAN_ID) ON DELETE SET NULL);

CREATE TABLE ORDERS (
ORD_NO INT(5) PRIMARY KEY, 
PURCHASE_AMT INTEGER NOT NULL,
ORD_DATE DATE NOT NULL,
CUSTOMER_ID INT(5) REFERENCES CUSTOMER(CUSTOMER_ID) ON DELETE CASCADE ,
SALESMAN_ID INT(5) REFERENCES SALESMAN(SALESMAN_ID) ON DELETE CASCADE); 
